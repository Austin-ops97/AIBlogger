    ...
    <div className="max-w-5xl mx-auto px-4 py-10">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex flex-wrap gap-3">
          <Link
            href="/admin/settings"
            className="flex items-center gap-2 bg-slate-100 text-slate-800 text-sm font-medium px-4 py-2.5 rounded-lg hover:bg-slate-200 transition-colors border border-slate-200"
          >
